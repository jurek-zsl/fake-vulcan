...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_UI_Input_ITouchpadGesturesController<D>::GesturesEnabled() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::UI::Input::ITouchpadGesturesController)->get_GesturesEnabled(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_UI_Input_ITouchpadGesturesController<D>::GesturesEnabled(bool value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_UI_Input_ITouchpadGesturesController<D>::TouchpadGlobalActionPerformed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::TouchpadGesturesController, winrt::Windows::UI::Input::TouchpadGlobalActionEventArgs> const& handler) const
    {
        winrt::event_token token{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_UI_Input_ITouchpadGesturesController<D>::TouchpadGlobalActionPerformed(winrt::event_token const& token) const noexcept
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::UI::Input::ITouchpadGesturesController)->remove_TouchpadGlobalActionPerformed(impl::bind_in(token)));
    }
