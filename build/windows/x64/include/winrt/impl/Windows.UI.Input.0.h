...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) GesturesEnabled() const;
        WINRT_IMPL_AUTO(void) GesturesEnabled(bool value) const;
        ...
        WINRT_IMPL_AUTO(winrt::event_token) TouchpadGlobalActionPerformed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::Input::TouchpadGesturesController, winrt::Windows::UI::Input::TouchpadGlobalActionEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) TouchpadGlobalActionPerformed(winrt::event_token const& token) const noexcept;
    };
